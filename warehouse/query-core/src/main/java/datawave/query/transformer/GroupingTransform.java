...
public class GroupingTransform extends DocumentTransform.DefaultDocumentTransform {
     ...
     *
     * {AGE.0=16, AGE.3=40, AGE.5=18, AGE.7=20, AGE.8=30, AGE.A=34, COUNT.0=1, COUNT.1=1, COUNT.2=1, COUNT.3=1, COUNT.4=2, COUNT.5=1, COUNT.6=1, COUNT.7=1,
     * COUNT.8=1, COUNT.9=1, COUNT.A=1, ETA.1=20, ETA.2=40, ETA.4=22, ETA.6=24, ETA.9=18, GENDER.0=MALE, GENDER.3=MALE, GENDER.5=FEMALE, GENDER.7=MALE,
     * GENDER.8=MALE, GENDER.A=MALE, GENERE.1=MALE, GENERE.2=MALE, GENERE.4=MALE, GENERE.6=MALE, GENERE.9=FEMALE}
     *
     *
     * @param documents
     */
